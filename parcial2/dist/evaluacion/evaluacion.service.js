...
let EvaluacionService = class EvaluacionService {
    ...
    async crearEvaluacion(evaluacion) {
        if (evaluacion.proyecto.mentor == evaluacion.profesor) {
            throw new common_1.BadRequestException('Los datos de la evaluacion son inválidos');
        }
...
exports.EvaluacionService = EvaluacionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(evaluacion_entity_1.EvaluacionEntity)),
